...
import 'package:mint_web/assembly/model/onboarding_specialist_to_dto.dart'
    as _i6;
import 'package:mint_web/assembly/model/specialist_model_to_dto.dart' as _i14;
import 'package:mint_web/assembly/model/user_model_to_dto.dart' as _i37;
import 'package:mint_web/assembly/modified_user_dto_to_map.dart' as _i16;
...
import 'package:mint_web/data/model/specialist_model_dto/specialist_model_dto.dart'
    as _i13;
import 'package:mint_web/data/model/user_model_dto/user_model_dto.dart' as _i15;
...
import 'package:mint_web/domain/entity/specialist_model/specialist_model.dart'
    as _i9;
import 'package:mint_web/domain/entity/user_model/user_model.dart' as _i11;
...
import 'package:mint_web/domain/usecase/fetch_specializations_use_case.dart'
    as _i44;
import 'package:mint_web/domain/usecase/fetch_user_use_case.dart' as _i45;
import 'package:mint_web/domain/usecase/log_out_use_case.dart' as _i46;
import 'package:mint_web/domain/usecase/update_user_data_use_case.dart' as _i48;
...
import 'package:mint_web/presentation/bloc/specialist/specialist_bloc.dart'
    as _i50;
import 'package:mint_web/presentation/bloc/user/user_bloc.dart' as _i49;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.Factory<_i11.UserModel, _i5.OnboardingSpecialist>>(
        () => _i12.UserModelFromOnboardingSpecialist());
    gh.factory<_i3.Factory<_i13.SpecialistModelDto, _i9.SpecialistModel>>(
        () => _i14.SpecialistModelToDto());
    gh.factory<_i3.Factory<Map<String, dynamic>, _i15.UserModelDto>>(
    ...
    gh.factory<_i30.UserRepository>(() => _i31.FirebaseUserRepository(
          ...
          gh<_i3.Factory<Map<String, dynamic>, _i15.UserModelDto>>(),
        ));
    ...
    gh.factory<
            _i3.Factory<_i35.Future<_i9.SpecialistModel>,
                _i13.SpecialistModelDto>>(
        () => _i36.SpecialistModelFromDto(gh<_i27.StorageService>()));
    gh.factory<_i3.Factory<_i35.Future<_i15.UserModelDto>, _i11.UserModel>>(
        () => _i37.UserModelToDto(gh<_i27.StorageService>()));
    gh.factory<_i3.Factory<_i35.Future<_i11.UserModel>, _i15.UserModelDto>>(
    ...
    gh.factory<_i39.SpecialistService>(() => _i40.FirebaseSpecialistService(
          ...
          gh<
              _i3.Factory<_i35.Future<_i9.SpecialistModel>,
                  _i13.SpecialistModelDto>>(),
          gh<_i3.Factory<_i13.SpecialistModelDto, _i9.SpecialistModel>>(),
        ));
    gh.factory<_i41.UserService>(() => _i42.FirebaseUserService(
          gh<_i30.UserRepository>(),
          gh<_i3.Factory<_i35.Future<_i11.UserModel>, _i15.UserModelDto>>(),
          gh<_i3.Factory<_i35.Future<_i15.UserModelDto>, _i11.UserModel>>(),
        ));
    ...
    gh.factory<_i44.FetchSpecializationsUseCase>(
        () => _i44.FetchSpecializationsUseCase(gh<_i39.SpecialistService>()));
    gh.factory<_i45.FetchUserUseCase>(
        () => _i45.FetchUserUseCase(gh<_i41.UserService>()));
    gh.factory<_i46.LogOutUseCase>(
        () => _i46.LogOutUseCase(gh<_i41.UserService>()));
    gh.factory<_i47.OnboardingBloc>(
        () => _i47.OnboardingBloc(gh<_i44.FetchSpecializationsUseCase>()));
    gh.factory<_i48.UpdateUserDataUseCase>(
        () => _i48.UpdateUserDataUseCase(gh<_i41.UserService>()));
    gh.factory<_i49.UserBloc>(() => _i49.UserBloc(
          gh<_i29.UserController>(),
          gh<_i45.FetchUserUseCase>(),
          gh<_i46.LogOutUseCase>(),
        ));
    gh.factory<_i50.SpecialistBloc>(() => _i50.SpecialistBloc(
          gh<_i43.AddSpecialistWithIdUseCase>(),
          gh<_i48.UpdateUserDataUseCase>(),
          gh<_i3.Factory<_i5.OnboardingSpecialist?, _i7.Onboarding>>(),
          gh<_i3.Factory<_i9.SpecialistModel, _i5.OnboardingSpecialist>>(),
          gh<_i3.Factory<_i11.UserModel, _i5.OnboardingSpecialist>>(),
          gh<_i29.UserController>(),
