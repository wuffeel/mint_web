...
import 'package:mint_web/domain/entity/onboarding/onboarding.dart' as _i20;
...
import 'package:mint_web/presentation/bloc/onboarding/onboarding_bloc.dart'
    as _i67;
import 'package:mint_web/presentation/bloc/patients/patients_bloc.dart' as _i68;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i18.Factory<_i19.OnboardingSpecialist?, _i20.Onboarding>>(
        () => _i21.OnboardingSpecialistFromOnboarding());
    gh.factory<_i18.Factory<_i22.SpecialistModel, _i19.OnboardingSpecialist>>(
    ...
    gh.factory<_i18.Factory<_i22.UserModel, _i19.OnboardingSpecialist>>(
    ...
    gh.factory<_i44.SpecialistService>(() => _i45.FirebaseSpecialistService(
          ...
          gh<
              _i18.Factory<_i46.Future<_i22.SpecialistModel>,
    ...
    gh.factory<_i53.UserBloc>(() => _i53.UserBloc(
          gh<_i54.UserController<_i22.UserModel?>>(),
    ...
    gh.factory<_i64.FetchPatientBookListUseCase>(
        () => _i64.FetchPatientBookListUseCase(gh<_i62.BookingService>()));
    gh.factory<_i65.FetchSpecialistDataUseCase>(
        () => _i65.FetchSpecialistDataUseCase(gh<_i44.SpecialistService>()));
    gh.factory<_i66.FetchSpecializationsUseCase>(
        () => _i66.FetchSpecializationsUseCase(gh<_i44.SpecialistService>()));
    gh.factory<_i67.OnboardingBloc>(
        () => _i67.OnboardingBloc(gh<_i66.FetchSpecializationsUseCase>()));
    gh.factory<_i68.PatientsBloc>(() => _i68.PatientsBloc(
          gh<_i64.FetchPatientBookListUseCase>(),
          gh<_i54.UserController<_i22.UserModel?>>(),
          gh<_i12.BookingController>(),
        ));
    gh.factory<_i69.SpecialistBloc>(() => _i69.SpecialistBloc(
          gh<_i57.AddSpecialistWithIdUseCase>(),
          gh<_i52.UpdateUserDataUseCase>(),
          gh<_i58.AddWorkInfoDataUseCase>(),
          gh<_i18.Factory<_i19.OnboardingSpecialist?, _i20.Onboarding>>(),
          gh<_i18.Factory<_i22.SpecialistModel, _i19.OnboardingSpecialist>>(),
          gh<_i18.Factory<_i22.UserModel, _i19.OnboardingSpecialist>>(),
          gh<_i54.UserController<_i22.UserModel?>>(),
          gh<_i41.SpecialistController>(),
        ));
    gh.factory<_i70.SpecialistInfoBloc>(() => _i70.SpecialistInfoBloc(
          gh<_i65.FetchSpecialistDataUseCase>(),
          gh<_i41.SpecialistController>(),
          gh<_i54.UserController<_i22.UserModel?>>(),
        ));
    gh.factory<_i71.AppointmentsBloc>(() => _i71.AppointmentsBloc(
          gh<_i64.FetchPatientBookListUseCase>(),
          gh<_i54.UserController<_i22.UserModel?>>(),
          gh<_i12.BookingController>(),
