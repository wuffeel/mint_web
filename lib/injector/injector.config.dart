...
import 'package:mint_web/assembly/modified_user_dto_to_map.dart' as _i17;
...
import 'package:mint_web/data/model/specialist_model_dto/specialist_model_dto.dart'
    as _i12;
import 'package:mint_web/data/model/user_model_dto/user_model_dto.dart' as _i16;
...
import 'package:mint_web/domain/entity/specialist_model/specialist_model.dart'
    as _i13;
import 'package:mint_web/domain/entity/user_model/user_model.dart' as _i4;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.Factory<_i4.UserModel, _i5.OnboardingSpecialist>>(
        () => _i6.UserModelFromOnboardingSpecialist());
    gh.factory<_i3.Factory<_i7.PatientBook, _i8.PatientBookDto>>(
        () => _i9.UserModelFromOnboardingSpecialist());
    gh.factory<_i3.Factory<_i5.OnboardingSpecialist?, _i10.Onboarding>>(
        () => _i11.OnboardingSpecialistFromOnboarding());
    gh.factory<_i3.Factory<_i12.SpecialistModelDto, _i13.SpecialistModel>>(
        () => _i14.SpecialistModelToDto());
    gh.factory<_i3.Factory<_i13.SpecialistModel, _i5.OnboardingSpecialist>>(
        () => _i15.SpecialistModelFromOnboardingSpecialist());
    gh.factory<_i3.Factory<Map<String, dynamic>, _i16.UserModelDto>>(
        () => _i17.ModifiedUserDtoToMap());
    gh.factory<
            _i3
            .Factory<_i18.OnboardingSpecialistDto, _i5.OnboardingSpecialist>>(
        () => _i19.OnboardingSpecialistToDto());
    ...
    gh.factory<_i33.UserRepository>(() => _i34.FirebaseUserRepository(
          ...
          gh<_i3.Factory<Map<String, dynamic>, _i16.UserModelDto>>(),
        ));
    ...
    gh.factory<_i40.BookingService>(() => _i41.FirebaseBookingService(
          ...
          gh<_i3.Factory<_i7.PatientBook, _i8.PatientBookDto>>(),
        ));
    gh.factory<_i3.Factory<_i42.Future<_i16.UserModelDto>, _i4.UserModel>>(
        () => _i43.UserModelToDto(gh<_i30.StorageService>()));
    gh.factory<_i3.Factory<_i42.Future<_i4.UserModel>, _i16.UserModelDto>>(
        () => _i44.UserModelFromDto(gh<_i30.StorageService>()));
    gh.factory<
            _i3.Factory<_i42.Future<_i13.SpecialistModel>,
                _i12.SpecialistModelDto>>(
        () => _i45.SpecialistModelFromDto(gh<_i30.StorageService>()));
    gh.factory<_i46.SpecialistService>(() => _i47.FirebaseSpecialistService(
          gh<_i26.SpecialistRepository>(),
          gh<
              _i3.Factory<_i42.Future<_i13.SpecialistModel>,
                  _i12.SpecialistModelDto>>(),
          gh<_i3.Factory<_i12.SpecialistModelDto, _i13.SpecialistModel>>(),
        ));
    gh.factory<_i48.UserService>(() => _i49.FirebaseUserService(
          gh<_i33.UserRepository>(),
          gh<_i3.Factory<_i42.Future<_i4.UserModel>, _i16.UserModelDto>>(),
          gh<_i3.Factory<_i42.Future<_i16.UserModelDto>, _i4.UserModel>>(),
        ));
    ...
    gh.factory<_i60.SpecialistBloc>(() => _i60.SpecialistBloc(
          ...
          gh<_i3.Factory<_i5.OnboardingSpecialist?, _i10.Onboarding>>(),
          gh<_i3.Factory<_i13.SpecialistModel, _i5.OnboardingSpecialist>>(),
          gh<_i3.Factory<_i4.UserModel, _i5.OnboardingSpecialist>>(),
          gh<_i32.UserController>(),
          gh<_i25.SpecialistController>(),
        ));
    return this;
