...
import 'package:mint_web/assembly/entity/specialist_model_from_onboarding_specialist.dart'
    as _i14;
import 'package:mint_web/assembly/entity/user_model_from_dto.dart' as _i36;
...
import 'package:mint_web/domain/usecase/fetch_specializations_use_case.dart'
    as _i45;
import 'package:mint_web/domain/usecase/fetch_user_use_case.dart' as _i46;
import 'package:mint_web/domain/usecase/log_out_use_case.dart' as _i47;
import 'package:mint_web/domain/usecase/update_user_data_use_case.dart' as _i50;
...
import 'package:mint_web/presentation/bloc/specialist_info/specialist_info_bloc.dart'
    as _i49;
import 'package:mint_web/presentation/bloc/user/user_bloc.dart' as _i51;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<
            _i3
            .Factory<_i12.OnboardingSpecialistDto, _i4.OnboardingSpecialist>>(
    ...
    gh.factory<_i3.Factory<_i15.UserModel, _i4.OnboardingSpecialist>>(
    ...
    gh.factory<_i3.Factory<_i35.Future<_i15.UserModel>, _i7.UserModelDto>>(
        () => _i36.UserModelFromDto(gh<_i27.StorageService>()));
    gh.factory<_i3.Factory<_i35.Future<_i7.UserModelDto>, _i15.UserModel>>(
        () => _i37.UserModelToDto(gh<_i27.StorageService>()));
    gh.factory<
            _i3.Factory<_i35.Future<_i10.SpecialistModel>,
    ...
    gh.factory<_i41.UserService>(() => _i42.FirebaseUserService(
          ...
          gh<_i3.Factory<_i35.Future<_i15.UserModel>, _i7.UserModelDto>>(),
          gh<_i3.Factory<_i35.Future<_i7.UserModelDto>, _i15.UserModel>>(),
        ));
    gh.factory<_i43.AddSpecialistWithIdUseCase>(
        () => _i43.AddSpecialistWithIdUseCase(gh<_i39.SpecialistService>()));
    gh.factory<_i44.FetchSpecialistDataUseCase>(
        () => _i44.FetchSpecialistDataUseCase(gh<_i39.SpecialistService>()));
    gh.factory<_i45.FetchSpecializationsUseCase>(
        () => _i45.FetchSpecializationsUseCase(gh<_i39.SpecialistService>()));
    gh.factory<_i46.FetchUserUseCase>(
        () => _i46.FetchUserUseCase(gh<_i41.UserService>()));
    gh.factory<_i47.LogOutUseCase>(
        () => _i47.LogOutUseCase(gh<_i41.UserService>()));
    gh.factory<_i48.OnboardingBloc>(
        () => _i48.OnboardingBloc(gh<_i45.FetchSpecializationsUseCase>()));
    gh.factory<_i49.SpecialistInfoBloc>(() => _i49.SpecialistInfoBloc(
          gh<_i44.FetchSpecialistDataUseCase>(),
          gh<_i22.SpecialistController>(),
          gh<_i29.UserController>(),
        ));
    gh.factory<_i50.UpdateUserDataUseCase>(
        () => _i50.UpdateUserDataUseCase(gh<_i41.UserService>()));
    gh.factory<_i51.UserBloc>(() => _i51.UserBloc(
          gh<_i29.UserController>(),
          gh<_i46.FetchUserUseCase>(),
          gh<_i47.LogOutUseCase>(),
        ));
    gh.factory<_i52.SpecialistBloc>(() => _i52.SpecialistBloc(
          gh<_i43.AddSpecialistWithIdUseCase>(),
          gh<_i50.UpdateUserDataUseCase>(),
          gh<_i3.Factory<_i4.OnboardingSpecialist?, _i5.Onboarding>>(),
          gh<_i3.Factory<_i10.SpecialistModel, _i4.OnboardingSpecialist>>(),
          gh<_i3.Factory<_i15.UserModel, _i4.OnboardingSpecialist>>(),
          gh<_i29.UserController>(),
          gh<_i22.SpecialistController>(),
        ));
    return this;
