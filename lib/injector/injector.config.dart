...
import 'package:mint_core/mint_bloc.dart' as _i32;
...
import 'package:mint_web/domain/usecase/update_user_data_use_case.dart' as _i30;
...
import 'package:mint_web/presentation/bloc/specialist_info/specialist_info_bloc.dart'
    as _i47;
import 'package:mint_web/presentation/bloc/user/user_bloc.dart' as _i31;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i30.UpdateUserDataUseCase>(
        () => _i30.UpdateUserDataUseCase(gh<_i3.UserService>()));
    gh.factory<_i31.UserBloc>(() => _i31.UserBloc(
          gh<_i32.UserController<_i11.UserModel?>>(),
          gh<_i18.FetchUserUseCase>(),
          gh<_i19.LogOutUseCase>(),
          gh<_i3.InitializeUserPresenceUseCase>(),
        ));
    gh.factory<_i33.VerifyOtpUseCase>(
        () => _i33.VerifyOtpUseCase(gh<_i22.PhoneAuthService>()));
    gh.factory<_i34.VerifyPhoneUseCase>(
        () => _i34.VerifyPhoneUseCase(gh<_i22.PhoneAuthService>()));
    gh.factory<_i35.AddSpecialistWithIdUseCase>(
        () => _i35.AddSpecialistWithIdUseCase(gh<_i27.SpecialistService>()));
    gh.factory<_i36.AddWorkInfoDataUseCase>(
        () => _i36.AddWorkInfoDataUseCase(gh<_i27.SpecialistService>()));
    ...
    gh.factory<_i41.FetchPatientBookListUseCase>(
        () => _i41.FetchPatientBookListUseCase(gh<_i38.BookingService>()));
    gh.factory<_i42.FetchSpecialistDataUseCase>(
        () => _i42.FetchSpecialistDataUseCase(gh<_i27.SpecialistService>()));
    gh.factory<_i43.FetchSpecializationsUseCase>(
        () => _i43.FetchSpecializationsUseCase(gh<_i27.SpecialistService>()));
    gh.factory<_i44.OnboardingBloc>(
        () => _i44.OnboardingBloc(gh<_i43.FetchSpecializationsUseCase>()));
    gh.factory<_i45.PatientsBloc>(() => _i45.PatientsBloc(
          gh<_i41.FetchPatientBookListUseCase>(),
          gh<_i32.UserController<_i11.UserModel?>>(),
        ));
    gh.factory<_i46.SpecialistBloc>(() => _i46.SpecialistBloc(
          gh<_i35.AddSpecialistWithIdUseCase>(),
          gh<_i30.UpdateUserDataUseCase>(),
          gh<_i36.AddWorkInfoDataUseCase>(),
    ...
    gh.factory<_i47.SpecialistInfoBloc>(() => _i47.SpecialistInfoBloc(
          gh<_i42.FetchSpecialistDataUseCase>(),
          gh<_i24.SpecialistController>(),
          gh<_i32.UserController<_i11.UserModel?>>(),
        ));
    return this;
