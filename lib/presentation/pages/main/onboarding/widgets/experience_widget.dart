...
class ExperienceWidget extends StatelessWidget {
  ...
  bool _experienceTouched(ExperienceInfoForm form) {
    return (form.experienceControl?.touched ?? false) ||
        (form.noExperienceControl?.touched ?? false);
  }
                    ...
                    return ReactiveDatePicker(
                      ...
                      builder: (context, picker, child) {
                        return _DateOfExperience(
                          ...
                          onTap: () {
                            picker.showPicker();
                            form.experienceControl?.markAsTouched();
                          },
                        );
                      },
                ...
                Row(
                  ...
                  children: <Widget>[
                    ReactiveCheckbox(
                      ...
                      splashRadius: 0,
                      onChanged: (_) =>
                          form.noExperienceControl?.markAsTouched(),
                    ),
                    const SizedBox(width: 4),
                    Text(l10n.iDoNotHaveExperience),
                  ],
                ),
                if (_hasRequiredError(control.errors) &&
                    _experienceTouched(form)) ...[
